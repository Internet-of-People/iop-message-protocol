...
#### PX05022 - New Neighbor - Too Many Profiles - Update
...
The simulated proximity server sends close to a maximum number (20,000) of profiles to the target server 
and then once the initialization process finishes, it sends a neighborhood update that will exceed the limit. 
The test then verifies that the target proximity server does not include any of the profiles that would exceed the limit 
...
The test sends a series of *NeighborhoodSharedActivityUpdateRequest* messages to share the first 19,990 of the generated 
profiles with the target proximity server and waits for corresponding *NeighborhoodSharedActivityUpdateResponse* messages.
...
*NeighborhoodSharedActivityUpdateRequest* message to add the remaining 60 profiles and reads the response.


###### Step 4:

The test connects to clNonCustomer port of the target proximity server and starts conversation sends *ActivitySearchRequest*:

  * `Message.id := 2`
  * `SingleRequest.version := [1,0,0]`
  * `ActivitySearchRequest.includeHostedOnly := false`
  * `ActivitySearchRequest.includeThumbnailImages := true`
  * `ActivitySearchRequest.maxResponseRecordCount := 100`
  * `ActivitySearchRequest.maxTotalRecordCount := 100`
  * `ActivitySearchRequest.type := "last"`
  * `ActivitySearchRequest.name := ""`
  * `ActivitySearchRequest.latitude := NO_LOCATION`
  * `ActivitySearchRequest.longitude := NO_LOCATION`
  * `ActivitySearchRequest.radius := 0`
  * `ActivitySearchRequest.extraData := ""`
...
The test selects 140 profiles and connects to the neighbor port of the target proximity server, verifies its identity,
and sends *NeighborhoodSharedActivityUpdateRequest* message to delete the selected profiles and reads the response.

Then the test generates 160 new profiles (with profile type set to "last") and sends *NeighborhoodSharedActivityUpdateRequest* 
message to add them to the target proximity server.


###### Step 6:

The test connects to clNonCustomer port of the proximity server and sends *ActivitySearchRequest*:

  * `Message.id := 1`
  * `SingleRequest.version := [1,0,0]`
  * `ActivitySearchRequest.includeHostedOnly := false`
  * `ActivitySearchRequest.includeThumbnailImages := false`
  * `ActivitySearchRequest.maxResponseRecordCount := 1000`
...
The target proximity server replies with *ActivitySearchResponse* that contains only identities numbers 19,991 to 20,000.
...
The target proximity server replies with *ActivitySearchResponse* that does not contain the profiles exceeding the limits.
...
The target proximity server replies with *ActivitySearchResponse* that contains all profiles retrieved in Step 6 plus 
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo1}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo2}},
      {ActionType = add, add {signedProfile matches $profileInfo3; signature := [1]; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo6}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo7}},
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo1}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo2}},
      {ActionType = add, add {signedProfile matches $profileInfo3; signature := array of 50 bytes 0x12; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo6}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo7}},
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo1}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo2}},
      {ActionType = add, add {signedProfile matches $profileInfo3; signature := otherwise valid signature with first byte XORed with 0x12; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo6}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo7}},
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      ...
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo2}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo3}},
      {ActionType = add, add {signedProfile matches $profileInfo4 except for thumbnailImageHash, which first byte is XORed with 0x12; thumbnailImage == $ThumbnailImage}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo6}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo7}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      ...
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo2}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo3}},
      {ActionType = add, add {signedProfile matches $profileInfo4 except for thumbnailImageHash := SHA256([1]); thumbnailImage == [1]}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo6}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo7}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      ...
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo2}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo3}},
      {ActionType = add, add {signedProfile matches $profileInfo4 except for thumbnailImageHash := SHA256($ProfileImageData); thumbnailImage == $ProfileImageData}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo6}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo7}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo1}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo2}},
      {ActionType = change, change {signedProfile matches $profileInfo3; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo6}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo7}},
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo1}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo2}},
      {ActionType = add, add {signedProfile matches $profileInfo3 except for name := ""; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo6}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo7}},
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "2.add.signedProfile.profile.version"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "2.add.signedProfile.profile.publicKey"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "2.add.signedProfile.profile.type"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "2.add.signedProfile.profile.name"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "2.add.signedProfile.profile.latitude"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "2.add.signedProfile.profile.longitude"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "2.add.signedProfile.profile.extraData"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "2.add.signedProfile.profile.profileImageHash"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "2.add.signedProfile.profile.thumbnailImageHash"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "2.add.signedProfile.signature"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "3.add.thumbnailImage"`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = add, add {signedProfile matches $profileInfo3 except for version := [1,0]; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = add, add {signedProfile matches $profileInfo3 except for thumbnailImageHash, which first byte is XORed with 0x12; thumbnailImage == $ThumbnailImage}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = add, add {signedProfile matches $profileInfo3 except for thumbnailImageHash := SHA256([1]); thumbnailImage == [1]}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = add, add {signedProfile matches $profileInfo3 except for thumbnailImageHash := SHA256($ProfileImageData); thumbnailImage == $ProfileImageData}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for version := [1,0]; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for version := [0,0,0]; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for publicKey := array of 300 'a' characters, thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for type := string of 70 'a' characters; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for type := string of 50 'ɐ' characters (UTF8 code 0xc990), which consume 2 bytes per character; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for type := ""; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for name := string of 70 'a' characters; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for name := string of 50 'ɐ' characters (UTF8 code 0xc990), which consume 2 bytes per character; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for name := ""; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for latitude := 987654321; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for longitude := 987654321; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for extraData is string of 270 'a' characters; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for extraData is string of 150 'ɐ' characters (UTF8 code 0xc990), which consume 2 bytes per character; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for profileImageHash := [1]; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for profileImageHash := array of 50 0x12 bytes; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for thumbnailImageHash := [1]; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7 except for thumbnailImageHash := array of 50 0x12 bytes; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7; signature := [1]; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7; signature := array of 50 bytes 0x12; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo7; signature := otherwise valid signature with first byte XORed with 0x12; thumbnailImage == []}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo1 except for thumbnailImageHash, which first byte is XORed with 0x12; thumbnailImage == $ThumbnailImage}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo1 except for thumbnailImageHash := SHA256([1]); thumbnailImage == [1]}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = change, change {signedProfile matches $profileInfo1 except for thumbnailImageHash := SHA256($ProfileImageData); thumbnailImage == $ProfileImageData}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = delete, delete {identityNetworkId is ID of $profileInfo3}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
 ...
 * `NeighborhoodSharedActivityUpdateRequest.items := 
   [
      {ActionType = change, change {signedProfile matches $profileInfo2 except for name := "X"; thumbnailImage == $ThumbnailImageData}},
      {ActionType = delete, delete {identityNetworkId is ID of $profileInfo2}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo4}},
      {ActionType = add, add {signedActivity.signature is a valid signature of signedActivity.activity, which matches $activityInfo5}},
   ]`
...
The target proximity server sends *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.add.signedProfile.profile.version"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.add.signedProfile.profile.publicKey"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.add.signedProfile.profile.type"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.add.signedProfile.profile.name"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.add.signedProfile.profile.latitude"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.add.signedProfile.profile.longitude"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.add.signedProfile.profile.extraData"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.add.signedProfile.profile.profileImageHash"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.add.signedProfile.profile.thumbnailImageHash"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.add.signedProfile.signature"`
...
The target proximity server sends *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.change.signedProfile.profile.version"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.change.signedProfile.profile.publicKey"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.change.signedProfile.profile.type"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.change.signedProfile.profile.name"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.change.signedProfile.profile.latitude"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.change.signedProfile.profile.longitude"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.change.signedProfile.profile.extraData"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.change.signedProfile.profile.profileImageHash"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.change.signedProfile.profile.thumbnailImageHash"`
...
The target proximity server sends the corresponding *Response*:
  ...
  * `Response.status == ERROR_INVALID_VALUE`
  * `Response.details == "1.change.signedProfile.signature"`
