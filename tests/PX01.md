...
The test connects to the primary port of the proximity server and sends *ActivitySearchRequest*:
...
The test connects to the primary port of the proximity server and sends *ActivitySearchPartRequest*:
