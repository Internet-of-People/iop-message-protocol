...
NEXT:
* just as 8023 but with updates outside NIP
* neighborhood initialization fails, meanwhile new profiles created, then new neighborhood initialization is called again
* neighborhood initialization takes too long
* result expiration and refresh
